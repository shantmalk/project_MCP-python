...
pd_mmar = pd_mmar.merge(pd_lesion[['lesion_id', 'mldlesion_arterial_dist', 'is_lrp', 'is_hrp', 'is_hrp_lad', 'is_lrp_lad', 'is_hrp_lcx', 'is_lrp_lcx', 'is_hrp_rca', 'is_lrp_rca', 'lumenareastenosis', 'plaquevolume_lesion', 'lesion_length', 'lumenvolume_lesion','lumenminimaldiameter', 'lesion_culprit_ica_ct']], how='left', on='lesion_id')
